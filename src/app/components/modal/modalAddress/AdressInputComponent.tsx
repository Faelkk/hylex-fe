    ...
    return (
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className={cn(
            "w-[12rem] 3pp:w-[16rem] pp:w-[22.75rem] md:w-[28.75rem] text-black-0 bg-gray-100 border border-black-500 rounded-[3px] p-1 font-roboto text-[14px] placeholder:text-black-0 focus:bg-gray-300 focus:border-black-600 transition-colors mt-1 ",
